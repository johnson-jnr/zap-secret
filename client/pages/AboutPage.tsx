const AboutPage = () => {
    return (
        <>
            <title> About us | ZapSecret </title>
            <div className="space-y-12 md:space-y-16">
                <section className="text-center">
                    ...
                    <p className="text-gray-600 text-base max-w-2xl mx-auto">
                        ...
                        we’ll generate a one-time, self-destructing link that
                ...
                <section className="grid gap-8 md:grid-cols-2">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 mt-1">
                                We don’t sell your data or secrets to
                                advertisers or analytics firms. We believe in
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 mt-1">
                                ...
                                no tracking scripts, no unnecessary logging, and
                                full transparency.
                            </p>
                        </div>
                    </div>
